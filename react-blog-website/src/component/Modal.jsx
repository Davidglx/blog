          ...
          <form className="px-4">
            ...
            <div className="mb-5">
              <input
                ...
                className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#e687280] outline-none focus:border-[#6a64f1] focus:shadow-md"
              />
               </div>
              <div className="mb-5">
                <input
